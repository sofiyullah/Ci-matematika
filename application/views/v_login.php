			...
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form">
					<div class="login100-form-avatar">
						<img src="Login_v12/images/mtk.jpg" alt="AVATAR">
					</div>
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "No.induk is required">
						<input class="input100" type="text" name="NO Induk" placeholder="No induk">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-user"></i>
						</span>
